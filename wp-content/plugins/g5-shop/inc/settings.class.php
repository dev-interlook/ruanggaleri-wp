        ...
        public function get_product_catalog_layout($inherit = false)
        {
            $config = apply_filters('g5shop_options_product_catalog_layout', array(
                ...
                'list' => array(
	                ...
	                'img' => G5SHOP()->plugin_url('assets/images/theme-options/layout-list.png'),
                ),
            ));
            if ($inherit) {
                $config = array(
        ...
        public function get_single_product_layout($inherit = false)
        {
            $config = apply_filters('g5shop_options_single_product_layout', array(
                ...
                'layout-3' => array(
	                ...
	                'img' => G5SHOP()->plugin_url('assets/images/theme-options/single-product-3.png')
                ),
                'layout-4' => array(
	                'label' => esc_html__('Layout 04', 'g5-shop'),
	                'img' => G5SHOP()->plugin_url('assets/images/theme-options/single-product-4.png')
                ),
                'layout-5' => array(
	                'label' => esc_html__('Layout 05', 'g5-shop'),
	                'img' => G5SHOP()->plugin_url('assets/images/theme-options/single-product-5.png')
                ),
            ));
            if ($inherit) {
                $config = array(
