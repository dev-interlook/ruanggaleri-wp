            ...
            return array(
                ...
                'fields' => array(
                    ...
                    'item_skin' => array(
                        ...
                        'desc' => esc_html__( 'Note: Skin 01, Skin 02 only apply for layout Grid', 'g5-shop' ),
                        'type' => 'image_set',
        ...
        public function config_section_single()
        {
            return array(
                ...
                'fields' => array(
                    ...
                    'single_product_breadcrumb_enable'        => G5CORE()->fields()->get_config_toggle( array(
	                    'id'       => 'single_product_breadcrumb_enable',
	                    'title'    => esc_html__( 'Breadcrumb Enable', 'g5-shop' ),
	                    'subtitle' => esc_html__( 'Turn Off this option if you want to hide breadcrumb (only show when page title hide)', 'g5-shop' ),
	                    'default'  => 'on'
                    ) ),
