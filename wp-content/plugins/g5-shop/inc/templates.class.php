...
if ( ! class_exists( 'G5Shop_Templates' ) ) {
    class G5Shop_Templates
    {
        ...
        public function init() {
        	...
        	add_action('init',array($this,'define_action'));
            ...
            add_action('template_redirect', array($this,'change_view_list') ,10);
	        add_action('init',array($this,'change_wishlist_button_position'));
	        add_action('init',array($this,'change_compare_button_position'));
        ...
        public function define_action() {
	        ...
	        add_action('woocommerce_before_single_product', array($this,'single_product_gallery'));
        }
        ...
        public function single_product_gallery() {
	        ...
	        if (in_array($single_product_layout,apply_filters('g5shop_layout_single_product_gallery',array('layout-3','layout-4','layout-5')) )) {
		        add_action('woocommerce_before_single_product_summary','g5shop_template_single_product_gallery');
	        }
        }
        ...
        public function change_gallery_thumbnail_image_size($size) {
	        $image_size = G5SHOP()->options()->get_option('product_image_size_gallery_thumbnail',array( 'width' => '150','height' => '150',));
	        $size['width'] = isset($image_size['width']) ? $image_size['width'] : '150';
	        $size['height'] = isset($image_size['height']) ? $image_size['height'] : '150';
        	return $size;
        }
        ...
        public function change_view_list() {
            if (is_shop() || is_product_taxonomy()) {
	            ...
	            G5SHOP()->options()->set_option('post_layout',$view);
                if ($view === 'list') {
