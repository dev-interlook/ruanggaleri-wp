...
function g5shop_template_breadcrumbs() {
	...
	$single_product_breadcrumb_enable = G5SHOP()->options()->get_option('single_product_breadcrumb_enable','on');
	if ($single_product_breadcrumb_enable !== 'on') {
		return;
	}
...
function g5shop_template_single_product_gallery() {
	$single_product_layout = G5SHOP()->options()->get_option('single_product_layout');
	G5SHOP()->get_template("single/gallery/{$single_product_layout}.php");
}
