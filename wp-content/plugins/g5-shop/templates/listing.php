...
if ($layout_settings !== '') {
    ...
    G5SHOP()->get_template( "loop/listing/{$post_layout}.php",array('post_classes' => $post_classes, 'post_inner_class' => $post_inner_class, 'columns_gutter' => $columns_gutter,'image_size' => $image_size,'image_ratio' => $image_ratio));
}
