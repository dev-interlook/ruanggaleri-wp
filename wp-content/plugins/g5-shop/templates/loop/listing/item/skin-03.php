...
$post_class .= ' g5shop__post-skin-modern';
...
<article <?php wc_product_class( $post_class, $product );?>>
    <div <?php echo join( ' ', $post_inner_attributes ) ?> class="<?php echo esc_attr( $post_inner_class ); ?>">
        ...
        <div class="g5core__post-featured g5shop__product-featured g5core__post-featured-bg-gradient">
            <?php
            ...
            remove_action('woocommerce_before_shop_loop_item_title','g5shop_template_loop_sale_count_down',10);
            /**
	        ...
	        <div class="g5core__loop-content g5shop__product-info">
		        <?php
		        /**
		        ...
		        //remove_action('woocommerce_after_shop_loop_item_title','g5shop_template_loop_swatches',30);
