...
if ( ! class_exists( 'G5Core_Custom_Css' ) ) {
	class G5Core_Custom_Css {
		...
		private function elementor_variables() {
			...
			return <<<CUSTOM_CSS
body.elementor-page {
	--e-global-typography-primary-font-family: {$primary_font['font_family']};
	--e-global-typography-primary-font-weight : {$primary_font['font_weight']};
...
CUSTOM_CSS;
		...
		private function site_color() {
			...
			$css             = "body {color:{$site_text_color}}";
			...
			$css           .= ".wp-block-image figcaption {color:{$caption_color}}";
...
CUSTOM_CSS;
		...
		public function gutenberg_editor_enqueue() {
			...
			$fonts = array(
				'body_font' => array(
					'tag'       => '.editor-styles-wrapper.editor-styles-wrapper',
					'important' => ''
				),
				'h1_font'   => array(
					'tag'       => '.editor-styles-wrapper.editor-styles-wrapper h1, .editor-styles-wrapper.editor-styles-wrapper .editor-post-title__block .editor-post-title__input',
					'important' => ''
				),
				'h2_font'   => array(
					'tag'       => '.editor-styles-wrapper.editor-styles-wrapper h2',
					'important' => ''
				),
				'h3_font'   => array(
					'tag'       => '.editor-styles-wrapper.editor-styles-wrapper h3',
					'important' => ''
				),
				'h4_font'   => array(
					'tag'       => '.editor-styles-wrapper.editor-styles-wrapper h4',
					'important' => ''
				),
				'h5_font'   => array(
					'tag'       => '.editor-styles-wrapper.editor-styles-wrapper h5',
					'important' => ''
				),
				'h6_font'   => array(
					'tag'       => '.editor-styles-wrapper.editor-styles-wrapper h6',
					'important' => ''
				),
				'display_1' => array(
