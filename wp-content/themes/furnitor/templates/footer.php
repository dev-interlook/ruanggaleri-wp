<?php
$footer_text = get_theme_mod('footer_text', esc_html__( 'Powered by Furnitor', 'furnitor' ));
...
<footer id="site-footer" class="site-footer">
	<?php do_action('furnitor-site-footer') ?>
	<div class="site-footer-bottom">
		<div class="container">
			<div class="site-info">
				<div class="container">
					<?php if (!empty($private_link)): ?>
					<?php echo wp_kses($private_link,wp_kses_allowed_html('user_description'))?>
					<?php endif; ?>
					<?php if (!empty($footer_text)): ?>
						<span class="powered-by"><?php echo do_shortcode($footer_text); ?></span>
					<?php endif; ?>
				</div>
			</div><!-- .site-info -->
		</div><!-- .container -->
