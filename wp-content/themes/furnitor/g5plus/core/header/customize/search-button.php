...
<div class="g5core-search-button">
	<a data-g5core-mfp="true" href="#g5core_search_popup" data-mfp-options='<?php echo esc_attr(wp_json_encode($args)) ?>'><i class="fal fa-search"></i><span><?php echo esc_html__('Search','furnitor') ?></span></a>
</div>
